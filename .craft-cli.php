...
return array(
     ...
     */
    'craft_app_path' => __DIR__.'/vendor/craftcms/cms/src',

    /**
     * Craft framework path
     *
     * Specify the path to the Yii framework folder
     * If you leave this blank, it will assume your
     * folder is <current directory>/craft/app/framework
     */
    'craft_framework_path' => __DIR__.'/vendor/yiisoft/yii/framework',
    ...
    'craft_config_path' => __DIR__.'/craft/config',
    ...
    'craft_storage_path' => __DIR__.'/craft/storage',
